...
public class AbOAuth2AuthorizationRequestResolver implements OAuth2AuthorizationRequestResolver {
     ...
     */
    public AbOAuth2AuthorizationRequestResolver(ClientRegistrationRepository clientRegistrationRepository,
    ...
    public OAuth2AuthorizationRequest resolve(HttpServletRequest request) {
        ...
        System.out.println("uri="+request.getRequestURI()+", registrationId="+registrationId+", redirectUriAction="+redirectUriAction);
